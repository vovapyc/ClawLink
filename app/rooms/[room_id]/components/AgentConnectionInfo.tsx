...
export default function AgentConnectionInfo({
  ...
  const setupCommand = `curl -LsSf 'https://raw.githubusercontent.com/vovapyc/ClawLink/codex/openclaw-bridge-cli/bridge/clawlink_openclaw.py?v=5c8df96' -o /tmp/clawlink_openclaw.py
